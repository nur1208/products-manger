...
public class AllProductsPane extends Stage implements DBInfo{
    ...
    TextField tfAddedDate = new TextField(); // not used
    ...
    public AllProductsPane(ObservableList<Product> data){
        ...
        this.data = data;
        // we have create object of AddNewProductDialog class that represent window tha will let us add new product.
        AddNewProductStage addNewProductStage = new AddNewProductStage(data);
        // here we have showing how to exit the edit mode to the user // Todo new
        ...
        // Todo new
        //HBox to store all the TextField in one line to look like a row in the table
        HBox hBox = new HBox();
        StackPane stackPane = new StackPane(hBox, table);// Todo new

        // Here we called setConverter() function And pass dateFormatter() function to it To make the date that appears in datePicker  object to appears in the format referred to by dateFormat variable
...
// Here we have added all the objects that we have created and modified their design in the object that we create from AllProductsPane
    ...
    // here we have create the function  showProduct() to We'll call it whenever a new product is selected in the table to display all the information
    // Note that all product information will be fetched based on its id.
...
//            table.refresh();
    ...
    private void setDownWindow(){
        ...
        moreInfoButton.setGraphic(new ImageView(new Image(getClass().getResourceAsStream("/images/upArrow.png"), 24, 24, true, true)));
    ...
    private void setUpWindow(){
        ...
        moreInfoButton.setGraphic(new ImageView(new Image(getClass().getResourceAsStream("/images/moreInfo.png"), 24, 24, true, true)));
